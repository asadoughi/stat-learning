...
### ii.
The mean of horsepower is ``r mean(horsepower, na.rm=T)`` horses. The RSE of
the lm.fit was ``r 4.906`` which indicates a percentage error of
``r 4.906/mean(horsepower, na.rm=T) * 100.0``%. The $R^2$ of the lm.fit was
