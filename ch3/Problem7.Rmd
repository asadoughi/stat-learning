...
Substitue the expression for $\hat{\beta}_0$ into $\hat{y}_i$:
...
Using formulat for $\hat{\beta}_1$ it is easy to see that the last term is
nothing but:
...
Compare this to the defintion of correlation and get:
